...
public class Day06B {
    public static void main(String[] args) {
        try {
            List<String> lines = Files.readAllLines(Paths.get("res/Day06_inputTest.txt"));
            ...
            if (isALoop) {
                System.out.println("The guard is in a loop.");
            } else {
                System.out.println("The guard is not in a loop.");
            }
