...
public class Day05 {
    public static void main(String[] args) {
        try {
            ...
            // Paso 3: se imprime el resultado de los updates correctos
            ...
            //Paso 4: se obtiene el elemento de enmedio de cada update y se va sumando. Usaremos BigInteger para evitar desbordamiento
